...
@Entity
@Table(name="rkpb_detil")
public class RkpbDetil implements Serializable {

	private static final long serialVersionUID = 12413211L;
	
	@EmbeddedId
	@AttributeOverrides({
		@AttributeOverride(name="idRkbp", column=@Column(name="ID_RKPB")),
		@AttributeOverride(name="noItem", column=@Column(name="NO_ITEM"))
	})
	private RkpbDetilId id;
	...
	public RkpbDetil(RkpbDetilId id, String kdBarang, String namaBarang, String merk, String tipe, String ukuran,
	 ...
	 */
	public void setId(RkpbDetilId id) {
		this.id = id;
	}
	...
	@JoinColumn(name="ID_RKPB", insertable=false, updatable=false)
	public Rkpb getRkpb() {
		return rkpb;
	}

	/**
	 * @param rkpb the rkpb to set
	 */
	public void setRkpb(Rkpb rkpb) {
		this.rkpb = rkpb;
	}
